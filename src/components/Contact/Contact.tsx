...
import { ContactProps } from '../../dtos/Contact'
import { Switch } from '@headlessui/react'
import { Button } from '../Button/Button'
import { Buttons } from '../../dtos/Button'

export const Contact: React.FC<ContactProps> = ({ className = '', id = '' }) =>
{
  const [agreed, setAgreed] = useState(false)

  return (
    <section id={id} className="w-full flex justify-center">
      <div className={`w-full px-4 py-12 sm:py-24 max-w-7xl isolate ${className}`}>
        <div
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-medium tracking-tight text-gray-900 sm:text-4xl">Contact</h2>
          <p className="mt-2 text-lg leading-8 text-gray-600">We will contact you as soon as possible, just fill in the required fields and continue.</p>
        </div>
        <form
          action="#"
          method="POST"
